                    ...
                    for name in appNames {
                        ...
                        for i1 in 0...5 {
                            for i2 in 0...5 {
                                ...
                                let app = App(teamId: team.id!, clusterId: (cluster?.id ?? UUID()), name: name, identifier: identifier, version: version, build: String(build), platform: platform, size: 5000, info: nil, hasIcon: false)
